...
<form id="animalInfoForm" method="post" action="InfoRegi">
    ...
    <table>
        <tr>
            ...
            <td><input type="text" id="scientificName" name="scientificName"></td>
        </tr>
        <tr>
            <td><label for="commonName">일반명 (Common Name):</label></td>
            <td><input type="text" id="commonName" name="commonName"></td>
        </tr>
        <tr>
            <td><label for="taxonomy">분류 (Taxonomy):</label></td>
            <td><input type="text" id="taxonomy" name="taxonomy" placeholder="계, 문, 강, 목, 과, 속, 종"></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            ...
            <td><input type="text" id="morphologicalCharacteristics" name="morphologicalCharacteristics" placeholder="크기, 색깔, 무늬, 체형"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" id="reproductiveInformation" name="reproductiveInformation" placeholder="번식 시기, 번식 방식, 새끼 수"></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            ...
            <td><input type="text" id="locationOfDiscovery" name="locationOfDiscovery" placeholder="GPS 좌표, 지리적 위치"></td>
        </tr>
        <tr>
            <td><label for="habitatType">서식지 유형 (Habitat Type):</label></td>
            <td><input type="text" id="habitatType" name="habitatType" placeholder="숲, 사막, 해양, 강"></td>
        </tr>
        <tr>
            <td><label for="habitatConditions">서식지 조건 (Habitat Conditions):</label></td>
            <td><input type="text" id="habitatConditions" name="habitatConditions" placeholder="기후, 식생, 물리적 환경"></td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" id="activityPatterns" name="activityPatterns" placeholder="주행성, 야행성, 계절적 이동"></td>
        </tr>
        <tr>
            <td><label for="socialStructure">사회적 구조 (Social Structure):</label></td>
            <td><input type="text" id="socialStructure" name="socialStructure" placeholder="단독 생활, 무리 생활"></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            ...
            <td><input type="text" id="conservationStatus" name="conservationStatus" placeholder="IUCN 레드 리스트 등급 (EX, EW, CR, EN, VU, NT, LC 등)"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" id="conservationActions" name="conservationActions" placeholder="보호 구역 설정, 번식 프로그램, 법적 보호"></td>
        </tr>
    </table>
